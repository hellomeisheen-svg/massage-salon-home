...
const pages = [
  ...
  {
    path: "/blog/kak-ponyat-chto-telu-nuzhen-otdyh",
    title: "Как понять, что телу нужен отдых — Блог Седьмого неба",
    description:
      "Тяжесть, усталость и напряжение не всегда проходят после сна. Разбираемся, на какие сигналы стоит обратить внимание.",
    ogTitle: "Как понять, что телу нужен отдых — Седьмое небо",
    ogDescription:
      "Тяжесть, усталость и напряжение не всегда проходят после сна. Разбираемся, на какие сигналы стоит обратить внимание.",
    ogImage: "https://7heavenmassage.ru/images/fresh-linen.webp",
    heading: "Как понять, что телу нужен отдых",
    text: "Тяжесть, усталость и напряжение не всегда проходят после сна. Разбираемся, на какие сигналы стоит обратить внимание.",
  },
  {
    path: "/blog/pochemu-vazhen-bereznyj-podhod",
    title: "Почему важен бережный подход — Блог Седьмого неба",
    description:
      "Оздоровительная практика — это не про силу воздействия, а про точность, внимание и уважение к состоянию человека.",
    ogTitle: "Почему важен бережный подход — Седьмое небо",
    ogDescription:
      "Оздоровительная практика — это не про силу воздействия, а про точность, внимание и уважение к состоянию человека.",
    ogImage: "https://7heavenmassage.ru/images/oils.webp",
    heading: "Почему важен бережный подход",
    text: "Оздоровительная практика — это не про силу воздействия, а про точность, внимание и уважение к состоянию человека.",
  },
  {
    path: "/blog/kak-podgotovitsya-k-pervomu-seansu",
    title: "Как подготовиться к первому сеансу — Блог Седьмого неба",
    description:
      "Несколько простых рекомендаций, чтобы прийти спокойно, не торопиться и получить максимум пользы от встречи.",
    ogTitle: "Как подготовиться к первому сеансу — Седьмое небо",
    ogDescription:
      "Несколько простых рекомендаций, чтобы прийти спокойно, не торопиться и получить максимум пользы от встречи.",
    ogImage: "https://7heavenmassage.ru/images/ambience.webp",
    heading: "Как подготовиться к первому сеансу",
    text: "Несколько простых рекомендаций, чтобы прийти спокойно, не торопиться и получить максимум пользы от встречи.",
  },
  {
    path: "/blog/skolko-vremeni-nuzhno-dlya-vosstanovleniya",
    title: "Сколько времени нужно для восстановления — Блог Седьмого неба",
    description:
      "После сеанса телу важно плавно вернуться к привычному ритму. Рассказываю, на что обратить внимание в первые часы.",
    ogTitle: "Сколько времени нужно для восстановления — Седьмое небо",
    ogDescription:
      "После сеанса телу важно плавно вернуться к привычному ритму. Рассказываю, на что обратить внимание в первые часы.",
    ogImage: "https://7heavenmassage.ru/images/instruments.webp",
    heading: "Сколько времени нужно для восстановления",
    text: "После сеанса телу важно плавно вернуться к привычному ритму. Рассказываю, на что обратить внимание в первые часы.",
  },
];
