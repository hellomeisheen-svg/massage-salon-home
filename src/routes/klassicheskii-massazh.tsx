      ...
      ) },
    {
      ...
      content: (
        <>
          ...
          <div className="mt-6 p-4 bg-[#F2F8FF] text-[#1C3C8C] rounded-lg font-medium">Если боль сильная, появилась внезапно, сохраняется длительное время или сопровождается онемением, отёком, слабостью либо повышенной температурой, сначала обратитесь к врачу.</div>
        </>
      ) },
    {
      label: "Зоны массажа",
