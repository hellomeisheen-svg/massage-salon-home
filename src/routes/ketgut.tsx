    ...
    content: (
      <div className="space-y-6">
        <div>
          ...
          <p className="body-text text-[#566A93] mt-4">
            Акупунктурный кетгут не заменяет обследование, лекарственную терапию, хирургическое лечение и назначения лечащего врача. При хронических и острых заболеваниях возможность процедуры согласовывают с профильным специалистом.
          </p>
        </div>
        <div>
          ...
          <p className="body-text text-[#566A93] mt-4">
            Перед процедурой можно уточнить у специалиста: точное название материала, производителя, состав и характеристики изделия, срок и условия хранения, документы, подтверждающие происхождение, срок предполагаемого рассасывания и способ утилизации расходных материалов.
          </p>
          <p className="body-text text-[#566A93] mt-4">
          ...
          <p className="body-text text-[#566A93] mt-4 italic">
            Важно: не следует утверждать, что нить полностью исчезает за одинаковый срок у всех пациентов. Скорость рассасывания зависит от конкретного материала, глубины и зоны постановки, а также от индивидуальной реакции организма.
          </p>
        </div>
        <div>
          <h4 className="font-noto-serif-narrow text-[20px] text-[#1C3C8C] mb-3">Эстетическое применение</h4>
          <p className="body-text text-[#566A93]">
            Использование рассасывающихся нитей в эстетических целях рассматривается отдельно. Возможность процедуры определяется после оценки состояния кожи, наличия воспалений, склонности к рубцам, аллергий, принимаемых препаратов и ожиданий пациента.
          </p>
          <p className="body-text text-[#566A93] mt-4">
            Акупунктурный кетгут не гарантирует омоложение, лифтинг, устранение отёков, изменение контуров тела или другой конкретный косметический результат. Если эстетическая цель связана с выраженными отёками, асимметрией или болью, сначала необходима медицинская консультация.
          </p>
        </div>
      </div>
    ),
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2">
            {[
              ...
              "другие состояния — только после консультации и оценки противопоказаний",
            ].map((item, i) => (
          ...
          <p className="body-text text-[#566A93] mt-4 italic">
            Наличие симптома или диагноза само по себе не означает, что акупунктурный кетгут вам подходит. При хронической усталости, нарушениях сна, отёках или длительной боли сначала необходимо выяснить возможную причину состояния.
          </p>
        </div>
      </div>
    ),
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2">
            {[
              ...
              "выраженной анемии и приёме антикоагулянтов/антиагрегантов",
              "аллергии на компоненты материала, антисептика или анестетика",
              "беременности и периоде грудного вскармливания",
              "острых инфекционных и лихорадочных заболеваниях",
              "воспалении, сыпи или повреждении кожи в зоне постановки",
              "декомпенсированном сахарном диабете и иммунодефиците",
              "активных онкологических заболеваниях или неясных новообразованиях",
              "склонности к патологическому рубцеванию",
              "недавно перенесённых операциях и алкогольном опьянении",
            ].map((item, i) => (
              <li key={i} className="flex items-start gap-3">
          ...
          <p className="body-text text-[#566A93] mt-4">
            Отдельного согласования могут требовать заболевания сердца, печени, почек и выраженное снижение давления. Перед процедурой обязательно сообщите о хронических заболеваниях и принимаемых препаратах.
          </p>
        </div>
      </div>
    ),
    ...
    content: (
      <div className="space-y-6">
        <div>
          ...
          <p className="body-text text-[#566A93]">
            Специалист проводит беседу и уточняет цель обращения, жалобы, заболевания, аллергии и состояние кожи. После этого определяется возможность процедуры и подходящий материал.
          </p>
          <p className="body-text text-[#566A93] mt-4">
            Затем подготавливается кожа, вскрываются стерильные одноразовые упаковки, может применяться местное обезболивание. Материал устанавливается в выбранную зону, накладывается повязка, специалист объясняет правила ухода.
          </p>
          <p className="body-text text-[#566A93] mt-4">
            Во время процедуры возможны покалывание, давление или кратковременная болезненность. После постановки возможны чувствительность, небольшой отёк, синяк или зуд.
          </p>
        </div>
      </div>
    ),
    ...
    content: (
      <div className="space-y-6">
        <div>
          ...
          <ul className="mt-4 space-y-2">
            {[
              "примите душ без парфюмированных средств и масел",
              "не наносите кремы и косметику на зоны постановки",
              "не употребляйте алкоголь",
              "не приходите натощак — допускается лёгкий приём пищи",
              "сообщите обо всех хронических заболеваниях и аллергиях",
              "сообщите о склонности к кровотечениям или патологическим рубцам",
            ].map((item, i) => (
              <li key={i} className="flex items-start gap-3">
                <span className="mt-2.5 h-1 w-1 shrink-0 rounded-full bg-[#A2CFFE]" />
                <span className="body-text text-[#566A93]">{item}</span>
        ...
        <div>
          ...
          <p className="body-text text-[#566A93]">
            В первые 24–48 часов: не срывайте повязку раньше времени, не трите и не расчёсывайте место постановки, не массируйте зону.
          </p>
          <p className="body-text text-[#566A93] mt-4">
            Не посещайте сауну, баню, бассейн и солярий. Избегайте интенсивных тренировок и тяжёлых нагрузок. Не пытайтесь самостоятельно извлекать нить.
          </p>
          <p className="body-text text-[#566A93] mt-4 font-medium text-[#1C3C8C]">
            Обратитесь к специалисту, если: боль усиливается, нарастает отёк, покраснение распространяется, появляется гной, нить выходит из кожи или ухудшается общее самочувствие.
          </p>
        </div>
      </div>
    ),
