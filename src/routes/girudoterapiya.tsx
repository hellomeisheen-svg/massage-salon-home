...
const faq = [
  ...
  },
  {
    ...
    a: "От 1\u00A0часа 30\u00A0минут до 2\u00A0часов. Продолжительность зависит от\u00A0индивидуальной схемы, количества пиявок и\u00A0зоны постановки.",
  },
  {
...
const girudoSections: { label: string; content: React.ReactNode }[] = [
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>Каждая пиявка используется только для одного пациента. После процедуры её не применяют повторно.</p>
        <p>Пиявки из природных водоёмов не используются.</p>
        <p>Перед процедурой кожу подготавливают с учётом требований безопасности. Места укусов после сеанса обрабатывают, затем накладывают повязку.</p>
        <p>Конкретные санитарные процедуры и документы на медицинских пиявок можно уточнить у специалиста перед записью.</p>
      </>
    ),
  },
  {
    label: "Когда процедуру могут рассматривать",
    content: (
      <>
  ...
  {
    label: "Когда процедуру не проводят",
    content: (
      <>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>Определяет зоны постановки и количество пиявок. Подготавливает кожу без раздражающих и ароматизированных средств.</p>
        <p>Устанавливает медицинских пиявок. После снятия обрабатывает места укусов и накладывает повязку.</p>
        <p>Объясняет правила ухода и признаки, при которых нужно обратиться за помощью.</p>
        <p>Продолжительность сеанса зависит от количества пиявок, зон постановки и реакции организма. В среднем процедура занимает от 1,5 до 2 часов.</p>
      </>
    ),
  },
  {
      ...
      <div className="container-1900 grid grid-cols-1 xl:grid-cols-2 gap-8 sm:gap-5 items-start">
        <div className="self-start xl:sticky xl:top-[140px] flex flex-col items-center xl:items-start text-center xl:text-left">
          ...
          <h2 className="font-noto-serif-narrow mt-6 ds-h2 text-[#1C3C8C] max-w-[520px] mx-auto xl:mx-0">
            ...
            <span className="hidden xl:inline">Что такое гирудотерапия</span>
          </h2>
