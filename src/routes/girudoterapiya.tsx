            ...
            },
            {
              ...
              mainEntity: [
                ...
                },
                {
                  ...
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "Один сеанс позволяет организму познакомиться с биологически активными веществами. Для устойчивого эффекта специалист может рекомендовать курс, подбирая количество пиявок индивидуально. Записаться на первую встречу можно через Max.",
                  },
                },
                {
                  "@type": "Question",
...
const faq = [
  ...
  {
    q: "Нужен ли курс?",
    a: "Один сеанс позволяет организму познакомиться с биологически активными веществами. Для устойчивого эффекта специалист может рекомендовать курс, подбирая количество пиявок индивидуально. Записаться на первую встречу можно через Max.",
  },
  {
