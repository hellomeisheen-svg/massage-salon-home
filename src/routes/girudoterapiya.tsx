                  ...
                  item: "https://7heavenmassage.ru/girudoterapiya" }] },
            {
              ...
              mainEntity: [
                    ...
                    text: "Совмещать их в один день нельзя из-за риска кровотечений. Между процедурами рекомендуется выдержать паузу в 2–3 суток. Мы составим план так, чтобы каждый метод работал максимально эффективно и безопасно для вас." } },
                {
                  ...
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "Возьмите с собой хорошее настроение и удобную одежду. Всё остальное мы предоставим: одноразовые материалы, стерильные инструменты и заботу о вашем комфорте. Если у вас есть вопросы — напишите нам заранее, мы с радостью поможем подготовиться." } },
                {
                  "@type": "Question",
                    ...
                    text: "В период температуры, озноба или активного кашля процедура противопоказана. После выздоровления важно дождаться полного исчезновения острых симптомов. При сохранении слабости стоит проконсультироваться с врачом перед сеансом." } },
                {
                  ...
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "Кабинет расположен в посёлке Трудовое. Принимаю по предварительной записи. Записаться можно в мессенджере — я уточню удобное время и дам необходимые рекомендации по подготовке к вашему первому сеансу." } },
                {
                  "@type": "Question",
                  name: "Нужен ли курс?",
                  acceptedAnswer: {
...
const faq = [
    ...
    a: "В период температуры, озноба или активного кашля процедура противопоказана. После выздоровления важно дождаться полного исчезновения острых симптомов. При сохранении слабости стоит проконсультироваться с врачом перед сеансом." },
  {
    ...
    a: "Кабинет расположен в посёлке Трудовое. Принимаю по предварительной записи. Записаться можно в мессенджере — я уточню удобное время и дам необходимые рекомендации по подготовке к вашему первому сеансу." }];
