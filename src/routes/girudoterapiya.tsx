            ...
            },
            {
              ...
              mainEntity: [
                ...
                },
                {
                  ...
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "Да, на месте укуса остаются небольшие точки, которые заживают от нескольких дней до двух недель. Это нормальная реакция кожи. В первые сутки важно не мочить и не тереть места постановки наших пиявок.",
                  },
                },
                {
                  "@type": "Question",
                  ...
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "Совмещать их в один день нельзя из-за риска кровотечений. Между процедурами рекомендуется выдержать паузу в 2–3 суток. Мы составим план так, чтобы каждый метод работал максимально эффективно и безопасно для вас.",
                  },
                },
                {
                  "@type": "Question",
                  ...
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "Курс зависит от задачи: для разового облегчения достаточно 1–2 сеансов, при хронических состояниях — 5–8 процедур с интервалом в 3–7 дней. Точную схему я составлю после первой встречи и оценки реакции тела.",
                  },
                },
                {
                  "@type": "Question",
                  ...
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "Цена зависит от количества пиявок и программы: медицинская гирудотерапия — от 4800 ₽, косметическая — от 600 ₽ за пиявку. На курсы из 3 и 6 сеансов действуют скидки до 15%. Длительность сеанса — около 1,5 часов.",
                  },
                },
                {
                  "@type": "Question",
...
const faq = [
  ...
  },
  {
    ...
    a: "Да, на месте укуса остаются небольшие точки, которые заживают от нескольких дней до двух недель. Это нормальная реакция кожи. В первые сутки важно не мочить и не тереть места постановки наших пиявок.",
  },
  {
    q: "Сочетается ли гирудотерапия с\u00A0массажем?",
    a: "Совмещать их в один день нельзя из-за риска кровотечений. Между процедурами рекомендуется выдержать паузу в 2–3 суток. Мы составим план так, чтобы каждый метод работал максимально эффективно и безопасно для вас.",
  },
  {
    q: "Сколько процедур нужно для\u00A0заметного эффекта?",
    a: "Курс зависит от задачи: для разового облегчения достаточно 1–2 сеансов, при хронических состояниях — 5–8 процедур с интервалом в 3–7 дней. Точную схему я составлю после первой встречи и оценки реакции тела.",
  },
  {
    q: "Как формируется стоимость сеанса?",
    a: "Цена зависит от количества пиявок и программы: медицинская гирудотерапия — от 4800 ₽, косметическая — от 600 ₽ за пиявку. На курсы из 3 и 6 сеансов действуют скидки до 15%. Длительность сеанса — около 1,5 часов.",
  },
  {
