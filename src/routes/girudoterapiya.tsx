  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>Возможность процедуры иногда обсуждают при:</p>
        ...
        <p>Этот список не является назначением. Наличие диагноза само по себе не означает, что гирудотерапия вам показана.</p>
      </>
    ),
  },
  {
