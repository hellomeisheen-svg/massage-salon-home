...
const faq = [
  {
    ...
    a: "Обычно процедура занимает от 1,5 до 2 часов. Точная продолжительность зависит от количества пиявок, выбранных зон и индивидуальной реакции организма.",
  },
  {
    q: "Сколько процедур может потребоваться?",
    a: "Единого курса для всех пациентов нет. Количество сеансов специалист определяет после консультации, учитывая:\n\n• цель обращения;\n• состояние здоровья и диагноз;\n• зоны постановки;\n• результаты обследований;\n• реакцию организма на первую процедуру;\n• рекомендации лечащего врача.\n\nНа консультации специалист объяснит, нужен ли повторный сеанс, какой интервал выбрать и когда оценивать результат.",
  },
  {
    q: "Можно ли совмещать гирудотерапию с массажем?",
    a: "Массаж по местам укусов проводить не рекомендуется. Воздействие на кожу может усилить кровоточивость и вызвать раздражение.\n\nИнтервал между гирудотерапией и массажем зависит от зоны постановки, количества пиявок и состояния кожи. Его определяет специалист.",
  },
  {
    q: "Какие ощущения возможны после сеанса?",
    a: "Реакция на процедуру индивидуальна. После сеанса возможны:\n\n• расслабление;\n• уменьшение ощущения напряжения;\n• чувство лёгкости;\n• снижение тяжести в отдельных зонах;\n• временная чувствительность или зуд в местах укусов;\n• небольшая кровоточивость в местах постановки.\n\nНезначительная кровоточивость после процедуры связана с воздействием секрета пиявки. Специалист обработает места укусов и наложит повязку, а также расскажет о дальнейшем уходе.\n\nЕсли боль, отёк или кровоточивость усиливаются, обратитесь за медицинской помощью.",
  },
  {
    q: "От чего зависит стоимость гирудотерапии?",
    a: "Стоимость зависит от:\n\n• продолжительности сеанса;\n• количества медицинских пиявок;\n• выбранных зон постановки;\n• необходимости предварительной консультации.\n\nЧтобы узнать точную цену и возможность проведения процедуры, оставьте заявку или свяжитесь со специалистом.",
  },
  {
    q: "Это больно?",
    a: "В момент постановки возможны кратковременные непривычные ощущения — покалывание, пощипывание или жжение. Их интенсивность зависит от индивидуальной чувствительности и зоны постановки.\n\nВо время процедуры специалист контролирует состояние пациента и при необходимости корректирует процесс, чтобы сохранить комфортные условия.",
  },
  {
    q: "Что делать, если после процедуры долго идёт кровь?",
    a: "Небольшая кровоточивость после снятия пиявок возможна. Не снимайте повязку раньше времени и выполняйте рекомендации специалиста.\n\nЕсли кровотечение не уменьшается, становится сильнее или сопровождается слабостью, выраженной болью, отёком или повышением температуры, обратитесь за медицинской помощью.",
  },
];
...
const girudoSections: { label: string; content: React.ReactNode }[] = [
  ...
  {
    label: "Какие пиявки используются",
    content: (
      <>
        ...
        <p className="mt-4">Конкретные санитарные процедуры и документы на медицинских пиявок можно уточнить у специалиста перед записью.</p>
      </>
    ),
  },
  {
    label: "Эстетическая гирудотерапия",
    content: (
      <>
        <p>Постановка небольших медицинских пиявок на лицо и локальные зоны рассматривается отдельно.</p>
        <p>Процедуру можно проводить только после оценки состояния кожи, общего здоровья, склонности к кровотечениям и принимаемых препаратов. Гирудотерапия не гарантирует омоложение, устранение отёков или другого конкретного эстетического результата.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>Гирудотерапия может рассматриваться как дополнительный метод в комплексном подходе при следующих заболеваниях и состояниях:</p>

        <div className="space-y-6 mt-6">
          <div>
            <h4 className="font-bold text-[#1C3C8C] mb-2 text-lg">Сердечно-сосудистые заболевания</h4>
            <ul className="list-disc pl-5 space-y-1">
              <li>ишемическая болезнь сердца;</li>
              <li>сердечная недостаточность I–II стадии;</li>
              <li>атеросклеротический и постинфарктный кардиосклероз;</li>
              <li>кардиалгии;</li>
              <li>дисциркуляторная атеросклеротическая энцефалопатия;</li>
              <li>гипертоническая болезнь I–III стадии.</li>
            </ul>
            <p className="mt-2 text-sm italic">При хронической сердечной недостаточности, сочетающейся с артериальной гипертонией, гирудотерапия может применяться для уменьшения выраженности отдельных проявлений заболевания и улучшения переносимости физических нагрузок. При декомпенсации сердечной деятельности процедура проводится только по согласованию с лечащим врачом.</p>
          </div>

          <div>
            <h4 className="font-bold text-[#1C3C8C] mb-2 text-lg">Заболевания органов дыхания</h4>
            <ul className="list-disc pl-5 space-y-1">
              <li>хронический бронхит;</li>
              <li>бронхиальная астма;</li>
              <li>хроническая пневмония;</li>
              <li>хронический синусит.</li>
            </ul>
          </div>

          <div>
            <h4 className="font-bold text-[#1C3C8C] mb-2 text-lg">Заболевания желудочно-кишечного тракта</h4>
            <ul className="list-disc pl-5 space-y-1">
              <li>спастические и атонические нарушения работы желудка и кишечника;</li>
              <li>гастрит;</li>
              <li>панкреатит;</li>
              <li>воспалительные заболевания печени и желчевыводящих путей.</li>
            </ul>
          </div>

          <div>
            <h4 className="font-bold text-[#1C3C8C] mb-2 text-lg">Неврологические заболевания</h4>
            <ul className="list-disc pl-5 space-y-1">
              <li>заболевания периферической нервной системы;</li>
              <li>сосудистые нарушения головного мозга;</li>
              <li>последствия травм центральной нервной системы и периферических нервов;</li>
              <li>неврозы;</li>
          ...
          <div>
            <h4 className="font-bold text-[#1C3C8C] mb-2 text-lg">Заболевания сосудов</h4>
            <ul className="list-disc pl-5 space-y-1">
              <li>облитерирующий эндартериит конечностей;</li>
              <li>тромбофлебит;</li>
              <li>геморрой.</li>
            </ul>
            <p className="mt-2 text-sm italic">При сосудистых заболеваниях особенно важно учитывать риск кровотечения и препараты, влияющие на свёртываемость крови.</p>
          </div>

          <div>
            <h4 className="font-bold text-[#1C3C8C] mb-2 text-lg">Гинекологические и урологические заболевания</h4>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <div>
            <h4 className="font-bold text-[#1C3C8C] mb-2 text-lg">Заболевания глаз</h4>
            <ul className="list-disc pl-5 space-y-1">
              <li>глаукома;</li>
          ...
          <div>
            <h4 className="font-bold text-[#1C3C8C] mb-2 text-lg">Кожные заболевания</h4>
            <ul className="list-disc pl-5 space-y-1">
              <li>псориаз;</li>
              <li>нейродермит;</li>
              <li>экзема.</li>
          ...
          <div>
            <h4 className="font-bold text-[#1C3C8C] mb-2 text-lg">Хирургические состояния</h4>
            <p>Гирудотерапия может рассматриваться в период восстановления для профилактики послеоперационных инфильтратов, тромбозов и лимфостаза. Сроки начала процедур согласовываются с лечащим хирургом.</p>
          </div>

          <div>
            <h4 className="font-bold text-[#1C3C8C] mb-2 text-lg">Эндокринные заболевания</h4>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <div>
            <h4 className="font-bold text-[#1C3C8C] mb-2 text-lg">Стоматологические заболевания</h4>
            <ul className="list-disc pl-5 space-y-1">
              <li>кариес;</li>
              <li>стоматит;</li>
              <li>хейлит;</li>
              ...
              <li>пародонтоз;</li>
              <li>периодонтит;</li>
              <li>альвеолярная пиорея.</li>
            </ul>
          </div>

          <div>
            <h4 className="font-bold text-[#1C3C8C] mb-2 text-lg">Травматологические и ортопедические состояния</h4>
            <ul className="list-disc pl-5 space-y-1">
              <li>воспалительные процессы;</li>
              <li>последствия огнестрельных ранений;</li>
              <li>фантомно-болевой синдром;</li>
              <li>другие последствия травм и заболеваний опорно-двигательного аппарата.</li>
            </ul>
          </div>

          <div>
            <h4 className="font-bold text-[#1C3C8C] mb-2 text-lg">Системные заболевания</h4>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <div>
            <h4 className="font-bold text-[#1C3C8C] mb-2 text-lg">Заболевания суставов</h4>
            <ul className="list-disc pl-5 space-y-1">
              <li>артрозы;</li>
              <li>артриты.</li>
            </ul>
            <p className="mt-2 text-sm italic">При реактивном артрите применение пиявок может способствовать уменьшению боли и отёчности суставов, однако процедура рассматривается только как дополнительный метод и не заменяет основное лечение.</p>
          </div>
        </div>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <p>Перечень не заменяет медицинскую консультацию. Перед процедурой обязательно сообщите специалисту о заболеваниях, аллергиях, беременности, недавних операциях и всех принимаемых препаратах. Не отменяйте назначенные лекарства самостоятельно, в том числе препараты, влияющие на свёртываемость крови.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <p className="mt-4">Продолжительность сеанса зависит от количества пиявок, зон постановки и реакции организма. В среднем процедура занимает от 1,5 до 2 часов.</p>
      </>
    ),
  },
  {
