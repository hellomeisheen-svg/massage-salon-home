...
const faq = [
  ...
  },
  {
    ...
    a: "От 1,5 до 2 часов. Продолжительность зависит от\u00A0индивидуальной схемы, количества пиявок и\u00A0зоны постановки.",
  },
  {
...
const girudoSections: { label: string; content: React.ReactNode }[] = [
  {
    label: "Обсуждаем состояние перед каждым визитом и\u00A0подбираем технику",
    content: (
      <>
