...
const faq = [
  {
    q: "Сколько пиявок ставят за\u00A0один сеанс?",
    a: "За\u00A0один сеанс используют от\u00A06 до\u00A010 пиявок — точное количество подбирается индивидуально под\u00A0состояние, зону воздействия и\u00A0цель процедуры. При локальных проблемах, например, боли в\u00A0шее или\u00A0спине, может быть достаточно меньшего количества; при общих задачах, таких как восстановление после\u00A0болезни или работа с\u00A0застойными явлениями, количество может быть увеличено. Решение принимаю на\u00A0месте после\u00A0осмотра и\u00A0беседы.",
  },
  {
    q: "Куда ставят пиявки при разных проблемах?",
    a: "Зоны постановки выбираются по\u00A0цели визита и\u00A0после\u00A0оценки состояния:\n\n• при напряжении в\u00A0шее и\u00A0затылке — пиявки ставят на\u00A0мягкие ткани шеи и\u00A0затылка;\n• при болях в\u00A0пояснице и\u00A0спине — зона пояснично-крестцового отдела;\n• при гинекологических задачах — область живота и\u00A0крестца;\n• при варикозе и\u00A0тяжести в\u00A0ногах — зоны на\u00A0бёдрах и\u00A0голенях;\n• при эстетической постановке — на\u00A0лицо, область вокруг глаз, шею, декольте.\n\nПеред процедурой специалист объясняет, почему выбраны именно эти зоны.",
  },
  {
    q: "Какой результат можно почувствовать после\u00A0первого сеанса?",
    a: "После\u00A0первого сеанса многие отмечают облегчение: снижается напряжение в\u00A0мышцах, уходит ощущение тяжести, улучшается сон и\u00A0общее самочувствие. При острых болях эффект может проявиться уже в\u00A0первые сутки; при хронических состояниях результат накапливается постепенно. Важно понимать, что гирудотерапия работает не\u00A0только локально, но\u00A0и\u00A0на\u00A0уровне микроциркуляции, поэтому улучшение часто приходит через\u00A0несколько дней после\u00A0процедуры.",
  },
  {
    q: "Остаются ли следы или синяки после\u00A0процедуры?",
    a: "Да, после\u00A0укуса пиявки на\u00A0коже остаются небольшие точки, которые могут напоминать синяки. Обычно они проходят от\u00A0нескольких дней до\u00A0двух недель — в\u00A0зависимости от\u00A0индивидуальной чувствительности кожи и\u00A0зоны постановки. Следы не\u00A0требуют специального лечения, но\u00A0в\u00A0первые сутки лучше не\u00A0мочить их, не\u00A0тереть и\u00A0не\u00A0наносить раздражающие средства. Если кожа особенно чувствительная, обязательно предупрежу об\u00A0этом заранее.",
  },
  {
    q: "Сочетается ли гирудотерапия с\u00A0массажем?",
    a: "Нет, совмещать гирудотерапию и\u00A0массаж в\u00A0один день не\u00A0рекомендуется. После\u00A0процедуры с\u00A0пиявками возможны небольшие кровотечения из\u00A0точек укуса, а\u00A0массаж усилит кровоток и\u00A0может спровоцировать повторное кровоизлияние или замедлить заживление. Между\u00A0сеансами стоит выдержать паузу — обычно не\u00A0менее 2–3 суток. Порядок процедур подберём так, чтобы каждая работала эффективно и\u00A0безопасно.",
  },
  {
    q: "Сколько процедур нужно для\u00A0заметного эффекта?",
    a: "Курс зависит от\u00A0задачи. Для\u00A0разового облегчения — достаточно 1–2 сеансов; при\u00A0хронических болях, застойных явлениях или восстановлении после\u00A0операции обычно требуется 5–8 процедур с\u00A0интервалом 3–7 дней. После\u00A0курса делаем перерыв и\u00A0при\u00A0необходимости повторяем. Конкретную схему составлю после\u00A0первой встречи, когда станет понятна реакция организма.",
  },
  {
