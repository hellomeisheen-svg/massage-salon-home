  ...
  return (
    <main className="bg-[#EFF6FF] py-4 sm:py-5">
      <section id="hero" className="container-1900 grid grid-cols-1 gap-4 sm:gap-5 xl:min-h-[calc(100vh-160px)] xl:grid-cols-2">
        <div className="ds-bento-shadow flex flex-col ds-card min-h-[720px] sm:min-h-[600px] xl:min-h-0 h-auto sm:h-auto min-h-[720px] sm:min-h-[600px] xl:h-auto p-5 sm:p-6 xl:p-10">
