            ...
            <div className="flex flex-col tablet-text-block xl:max-w-[640px]">
              ...
              <p className="mt-4 text-[16px] font-light leading-[26px] text-[#566A93]">
                <span className="hidden sm:inline">
                  Оздоровительная практика с{"\u00A0"}медицинскими пиявками. Эффект — поддержка самочувствия, ощущение лёгкости и{"\u00A0"}более внимательный контакт с{"\u00A0"}телом. Кабинет в{"\u00A0"}посёлке Трудовое.
                </span>
                <span className="sm:hidden">
                  Медицинские пиявки для поддержки самочувствия и&nbsp;ощущения лёгкости. Кабинет в&nbsp;посёлке Трудовое, рядом с&nbsp;Владивостоком и&nbsp;Артёмом.
                </span>
              </p>
