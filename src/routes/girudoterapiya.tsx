              ...
              mainEntity: [
                {
                  ...
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "Многие отмечают облегчение уже в первые сутки: снижается мышечное напряжение, улучшается сон и общее самочувствие. Эффект от гирудотерапии часто нарастает постепенно в течение нескольких дней после процедуры.",
                  },
                },
                {
                  "@type": "Question",
                ...
                },
                {
                  ...
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "Совмещать их в один день нельзя из-за риска кровотечений. Между процедурами рекомендуется выдержать паузу в 2–3 суток. Мы составим план так, чтобы каждый метод работал максимально эффективно и безопасно.",
                  },
                },
                {
                  "@type": "Question",
                  name: "Сколько процедур нужно для заметного эффекта?",
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "Курс зависит от задачи: для разового облегчения достаточно 1–2 сеансов, при хронических состояниях — 5–8 процедур с интервалом в 3–7 дней. Точную схему я составлю после первой встречи и оценки реакции организма.",
                  },
                },
                {
                  "@type": "Question",
                  name: "Как формируется стоимость сеанса?",
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "Цена зависит от количества пиявок и программы: медицинская гирудотерапия — от 4800 ₽, косметическая — от 600 ₽ за пиявку. На курсы из 3 и 6 сеансов действуют скидки до 15%. Длительность сеанса составляет 1,5 часа.",
                  },
                },
                {
                  "@type": "Question",
...
const faq = [
  {
    ...
    a: "Многие отмечают облегчение уже в\u00A0первые сутки: снижается мышечное напряжение, улучшается сон и\u00A0общее самочувствие. Эффект от\u00A0гирудотерапии часто нарастает постепенно в\u00A0течение нескольких дней после\u00A0процедуры.",
  },
  {
  ...
  },
  {
    ...
    a: "Совмещать их в\u00A0один день нельзя из-за\u00A0риска кровотечений. Между\u00A0процедурами рекомендуется выдержать паузу в\u00A02–3 суток. Мы составим план так, чтобы каждый метод работал максимально эффективно и\u00A0безопасно.",
  },
  {
    q: "Сколько процедур нужно для\u00A0заметного эффекта?",
    a: "Курс зависит от\u00A0задачи: для\u00A0разового облегчения достаточно 1–2 сеансов, при\u00A0хронических состояниях — 5–8 процедур с\u00A0интервалом в\u00A03–7 дней. Точную схему я составлю после\u00A0первой встречи и\u00A0оценки реакции организма.",
  },
  {
    q: "Как формируется стоимость сеанса?",
    a: "Цена зависит от\u00A0количества пиявок и\u00A0программы: медицинская гирудотерапия — от\u00A04800 ₽, косметическая — от\u00A0600 ₽ за\u00A0пиявку. На\u00A0курсы из\u00A03 и\u00A06 сеансов действуют скидки до\u00A015%. Длительность сеанса составляет 1,5 часа.",
  },
  {
