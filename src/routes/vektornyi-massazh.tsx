...
export const Route = createFileRoute("/vektornyi-massazh")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Векторный оздоровительный массаж в Трудовом (Владивосток). Глубокая работа по анатомическим линиям для снятия зажимов и возвращения свободы движений." },
