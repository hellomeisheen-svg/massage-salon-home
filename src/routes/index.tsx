                ...
                mainEntity: [
                  {
                    ...
                    acceptedAnswer: {
                      "@type": "Answer",
                      text: "Мы начинаем с короткой беседы, чтобы обсудить ваш запрос и самочувствие. Я подбираю техники и силу воздействия индивидуально. Первый сеанс помогает познакомиться с методами и почувствовать начальный эффект расслабления.",
                    },
                  },
                  {
                    "@type": "Question",
                  ...
                  {
                    "@type": "Question",
                    name: "Где именно вы находитесь в Трудовом?",
                    acceptedAnswer: {
                      "@type": "Answer",
