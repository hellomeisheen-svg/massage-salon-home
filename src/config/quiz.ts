...
export const QUIZ_CONFIG: {
  ...
  services: [
    ...
    { id: "cups-fire", name: "Стихия Огонь (стеклянные банки)", duration: "10-20 мин", price: "2 000 ₽", tags: ["wellness"], isWellness: true, description: "Классическая интенсивная техника с глубоким вакуумным воздействием. Подходит как дополнение к массажу с глубокой проработкой." },
    { id: "cups-air", name: "Стихия Воздух (мягкие банки)", duration: "10-25 мин", price: "1 000-2 000 ₽", tags: ["wellness"], isWellness: true, description: "Мягкая вакуумная техника: мастер регулирует силу воздействия под ваши ощущения. Подходит для деликатного дополнения к расслабляющему массажу." },
