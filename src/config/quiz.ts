...
export const QUIZ_CONFIG: {
  ...
  services: [
    { id: "vector", name: "Векторный массаж", duration: "120 мин", price: "5 000 ₽", tags: ["relax", "lymph", "wellness"], description: "Комплексная работа с телом, восстанавливающая естественный баланс." },
    { id: "lymph", name: "Лимфодренажный массаж", duration: "120 мин", price: "5 000 ₽", tags: ["relax", "lymph"] },
    { id: "lymphatic", name: "Лимфатический массаж тела", duration: "120 мин", price: "5 000 ₽", tags: ["relax", "lymph"] },
    { id: "classic-full", name: "Классический массаж", duration: "60 мин", price: "2 000 ₽", tags: ["relax", "spine"] },
    ...
    { id: "lymph-face", name: "Лимфодренажный — лицо", duration: "40 мин", price: "2 000 ₽", tags: ["face"] },
    ...
    { id: "cups-fire", name: "Стихия Огонь (стеклянные банки)", duration: "10 мин", price: "2 000 ₽", tags: ["wellness"], isWellness: true },
    { id: "cups-air", name: "Стихия Воздух (мягкие банки)", duration: "10-25 мин", price: "1 000-2 000 ₽", tags: ["wellness"], isWellness: true },
    { id: "girudo-med", name: "Гирудотерапия (медицинские пиявки)", duration: "", price: "пакеты 6/16/74", tags: ["wellness"], isWellness: true },
    { id: "girudo-cosm", name: "Гирудотерапия (косметические пиявки)", duration: "", price: "от 600 ₽ за шт", tags: ["face", "wellness"], isWellness: true },
    { id: "ketgut", name: "Акупунктурный кетгут", duration: "", price: "по запросу", tags: ["wellness"], isWellness: true },
  ],
  scenarios: [
