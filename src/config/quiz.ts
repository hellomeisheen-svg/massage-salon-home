...
export const QUIZ_CONFIG: {
  ...
  services: [
    ...
    { id: "lymph_face", name: "Лимфатический массаж — лицо", duration: "40 минут", price: "2 000 ₽", tags: ["face"], description: "Деликатная работа с оттоком жидкости: уменьшает отёчность и поддерживает чёткий овал." },
    ...
    { id: "lymphatic", name: "Лимфатический массаж — всё тело", duration: "2 часа", price: "5 000 ₽", tags: ["lymph", "relax"], description: "Мягкая работа с естественными путями оттока жидкости: уменьшает отёчность и возвращает лёгкость." },
  ],
};
