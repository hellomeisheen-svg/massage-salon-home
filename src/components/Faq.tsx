...
const items = [
  ...
  },
  {
    ...
    a: "Приходите в\u00A0удобной одежде. Специальной подготовки не\u00A0требуется — бельё, полотенца и\u00A0всё необходимое для\u00A0вашего комфорта уже заботливо подготовлено в\u00A0кабинете.",
  },
  {
