...
const items = [
  ...
  },
  {
    ...
    a: "Кабинет расположен в\u00A0посёлке Трудовое. Принимаю по\u00A0записи. Записаться можно в\u00A0мессенджере — я уточню удобное время и\u00A0дам рекомендации к\u00A0вашему первому сеансу.",
  },
];
