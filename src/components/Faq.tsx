...
const items = [
  {
    ...
    a: "Начнём со\u00A0знакомства с\u00A0кабинетом: короткая беседа о\u00A0самочувствии и\u00A0целях, а\u00A0затем — мягкий пробный сеанс, чтобы вы почувствовали формат работы и\u00A0атмосферу.",
  },
  {
    q: "Как выбрать процедуру?",
    a: "Не\u00A0обязательно выбирать заранее — на\u00A0первой встрече мы вместе подберём подходящую практику под\u00A0ваше состояние, пожелания и\u00A0текущий запрос организма.",
  },
  {
    q: "Что взять с собой?",
    a: "Возьмите с собой хорошее настроение и удобную одежду. Всё остальное мы предоставим: одноразовые материалы, стерильные инструменты и заботу о вашем комфорте. Если у вас есть вопросы — напишите нам заранее, мы с радостью поможем подготовиться.",
  },
  {
    q: "Есть ли противопоказания?",
    a: "Да, у\u00A0каждой оздоровительной практики есть свои ограничения. Перед\u00A0сеансом мы обязательно уточним состояние здоровья и\u00A0подберём самый безопасный вариант работы.",
  },
  {
    q: "Можно при беременности?",
    a: "Некоторые мягкие практики допустимы, но\u00A0требуют обязательного согласования с\u00A0вашим врачом. Расскажите о\u00A0сроке и\u00A0самочувствии — мы подберём бережный вариант поддержки.",
  },
  {
