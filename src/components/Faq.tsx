...
const items = [
  ...
  },
  {
    ...
    a: "Приходите в\u00A0любой удобной одежде. Специальной подготовки не\u00A0требуется — свежее бельё, полотенца и\u00A0всё необходимое для\u00A0вашего комфорта уже заботливо подготовлено в\u00A0кабинете.",
  },
  {
  ...
  },
  {
    ...
    a: "Кабинет расположен в\u00A0посёлке Трудовое. Принимаю по\u00A0предварительной записи. Записаться в мессенджере можно через\u00A0Max — я уточню удобное время и\u00A0дам рекомендации к\u00A0вашему первому сеансу.",
  },
];
