...
const items = [
  ...
  },
  {
    ...
    a: "Кабинет расположен в\u00A0посёлке Трудовое. Принимаю по\u00A0предварительной записи. Записаться можно через\u00A0Max — я уточню удобное время и\u00A0дам рекомендации к\u00A0вашему первому сеансу.",
  },
];
