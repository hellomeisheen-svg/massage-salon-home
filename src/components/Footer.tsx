          ...
          <div className="flex flex-col justify-between gap-8 ds-card ds-bento-shadow p-5 xl:p-[30px]">
            <div>
              ...
              <p className="mt-4 xl:mt-5 body-text text-[#566A93] max-w-[440px]">
                Уютное пространство в центре посёлка Трудового, где можно прийти чуть раньше, выдохнуть и спокойно настроиться на сеанс. Принимаю по предварительной записи жителей Трудового, Владивостока, Артема, ближайших населенных пунктов.
              </p>
            </div>
