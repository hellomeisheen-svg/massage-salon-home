...
export function Hero() {
  return (
    <main className="bg-[#EFF6FF] py-4 sm:py-5">
      <section className="container-1900 grid grid-cols-1 gap-4 sm:gap-5 xl:h-[calc(100vh-160px)] xl:min-h-[640px] xl:grid-cols-2">
        {/* Content card */}
        <div className="flex min-h-0 flex-col rounded-[12px] border border-[#daebff] bg-white p-5 sm:min-h-[520px] sm:p-6 xl:h-full xl:min-h-0 xl:p-10">
