        ...
        <div className="relative z-10 max-w-[900px] xl:max-w-[1100px]">
          <h2 className="font-noto-serif-narrow ds-h1 text-[#1C3C8C]">
            '''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''
                                                        ...
                                                        Исправь только отображаемый текст в компоненте:

src/components/HabitQuote.tsx

Сейчас в блоке отображается служебная фраза:

«Команда на восстановление текста „Регулярная забота о теле — привычка...“»

Замени её на точный текст:

«Регулярная забота о теле — привычка...»

Важно:

- на сайте должна отображаться только фраза «Регулярная забота о теле — привычка...»;

- не добавляй слова «Команда», «восстановление текста» или любые другие пояснения;

- не добавляй кавычки, если их не было в исходном дизайне;

- не изменяй структуру компонента;

- не изменяй SEO, meta-теги, sitemap.xml, robots.txt, alt-тексты, lang или другие файлы;

- не меняй дизайн и стили.

Измени только файл:

src/components/HabitQuote.tsx

После изменения проверь, что видимый текст блока точно равен:
