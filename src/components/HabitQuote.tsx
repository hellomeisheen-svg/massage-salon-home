        ...
        <div className="relative z-10 max-w-[900px] xl:max-w-[1100px]">
          <h2 className="font-noto-serif-narrow ds-h1 text-[#1C3C8C]">
            '''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''
                                                        ...
                                                        Верни только исходный текст в компоненте HabitQuote.tsx.

Было:

«Регулярная забота о теле — привычка...»

Восстанови именно исходный текст, который был до последнего SEO-изменения. Не добавляй и не изменяй никакие другие тексты, заголовки, alt-тексты, SEO-метаданные, блоки, компоненты, дизайн или функциональность.

После исправления проверь, что изменён только файл:

src/components/HabitQuote.tsx

В конце сообщи:

- какой текст был восстановлен;

- какие файлы изменены;

- подтверждение, что остальные SEO-изменения не затронуты.
          </h2>
        </div>
