            ...
            <div className="pr-12">
              ...
              <p className="mt-3 text-[15px] font-light leading-[1.5] text-[#566A93] sm:text-[16px]">
                '''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''
                                            ...
                                            На страницах у-услуг в блоке Форматы и стоимость в карточках на планшетных и мобильных версиях внеси изменения в контент. Там, где один сеанс и шесть пиявок, этот контент должен располагаться в одну строку через точку-разделитель, как на карточках услуг.

Внеси изменения только в планшетную и мобильную версию. На десктопе ничего не меняй
              </p>
            </div>
