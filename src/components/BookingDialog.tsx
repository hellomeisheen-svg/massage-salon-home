            ...
            <div className="pr-12">
              ...
              <p className="mt-3 text-[15px] font-light leading-[1.5] text-[#566A93] sm:text-[16px]">
                '''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''
                                            ...
                                            На всех страницах услуг перепроверь правки в блоке "Формат и стоимость", где контент: один сеанс, три сеанса, шесть сеансов. Нужно удалить время. Например, три сеанса, цена шесть часов. Шесть часов мы удаляем. Три сеанса, цена 120 минут. 120 минут мы удаляем. Эта информация про время не нужна конкретно в блоках с сеансами. Перепроверь на всем макете и удали это
              </p>
            </div>
