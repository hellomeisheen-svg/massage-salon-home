  ...
  return (
    <>
      ...
      <div className="hidden h-20 w-full items-center justify-between ds-card px-5 py-2.5 xl:flex xl:px-[30px]">
        {/* Logo */}
        <Link to="/" aria-label="На главную" className="flex h-14 items-center hover:opacity-70 transition-opacity">
      ...
      <div className="flex h-16 w-full items-center justify-between ds-card px-4 py-2.5 xl:hidden">
        {/* Logo */}
        <Link to="/" aria-label="На главную" onClick={() => setMenuOpen(false)} className="flex h-12 items-center hover:opacity-70 transition-opacity">
          <Logo className="h-full w-auto" />
        </Link>
