        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-10 xl:gap-20 items-center">
          ...
          <div className="flex flex-col items-start">
            ...
            <div className="mt-8 space-y-6 text-[#566A93] body-text">
              ...
              <p>
                Я верю, что путь к здоровью лежит через внимание к себе и умение вовремя замедлиться. Приглашаю вас в «Седьмое небо», чтобы восстановить силы и обрести гармонию.
              </p>
            </div>
