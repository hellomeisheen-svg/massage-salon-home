...
function AboutService({ content }: { content: ServicePageContent }) {
  ...
  return (
    <section id="services" className="scroll-mt-[140px] bg-[#EFF6FF] ds-section lg:h-[calc(100vh-100px)] lg:overflow-hidden lg:flex lg:flex-col">
      <div className="container-1900 grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-5 items-start lg:h-full lg:min-h-0">
        <div className="self-start lg:sticky lg:top-0 lg:py-10 flex flex-col items-center lg:items-start text-center lg:text-left">
          <span
        ...
        <div 
          ...
          className="flex flex-col gap-4 lg:h-full lg:overflow-y-auto lg:scrollbar-none lg:py-10"
        >
