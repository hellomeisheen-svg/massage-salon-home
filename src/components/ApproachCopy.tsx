          ...
          <ul className="mt-[120px] sm:mt-[140px] flex flex-col gap-8">
            {environmentItems.map((item, i) => (
              <li key={i} className="group relative">
                ...
                <div className="absolute -top-2 -left-2 w-10 h-10 border-l border-t border-[#DAEBFF] rounded-tl-[4px] transition-colors duration-500 group-hover:border-[#88C1FF]" aria-hidden="true" />
