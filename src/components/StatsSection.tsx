  ...
  return (
    ...
    >
      <div className="container-1900">
        <div className="flex flex-col gap-10 lg:grid lg:grid-cols-2 lg:gap-5 lg:items-start xl:grid xl:grid-cols-2 xl:gap-5 xl:items-start">
          {/* Left: label + heading */}
          <div className="text-left lg:text-left xl:text-left">
            <span
            ...
            <h2 className="font-noto-serif-narrow mt-6 ds-h2 text-[#1C3C8C] max-w-[520px] mx-0 lg:mx-0 xl:mx-0">
