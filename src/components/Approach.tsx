            ...
            <div className="absolute inset-x-0 bottom-6 flex flex-col gap-3 overflow-hidden">
              <div className="marquee-track">
                {[...practices, ...practices, ...practices, ...practices].map((p, i) => (
                  <span
                    key={`r1-${i}`}
                    className="inline-flex items-center justify-center rounded-lg bg-white px-5 py-3 min-h-[48px] text-[16px] xl:text-[18px] font-light leading-none text-[#1C3C8C] shadow-[0_8px_20px_-8px_rgba(28,60,140,0.25)] whitespace-nowrap"
                    style={{ fontFamily: heading }}
                  >
                    {p}
                  </span>
