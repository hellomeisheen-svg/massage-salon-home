...
export function Approach() {
  return (
    <section id="advantages" className="scroll-mt-[120px] bg-[#EFF6FF] py-[70px]">
      <div className="container-1900 px-4 sm:px-5 grid grid-cols-1 xl:grid-cols-2 gap-6">
        {/* Left column */}
        <div className="flex flex-col gap-6 xl:grid xl:grid-rows-2 xl:gap-6 xl:h-full">
          ...
          <div className="ds-card p-8 sm:p-10 xl:p-12 min-h-[380px] xl:min-h-0 xl:h-full flex flex-col justify-between">
            ...
            <p className="mt-8 body-text text-[#4A5C85] max-w-[440px]">
              ...
              <li key={i}>
                <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:gap-5">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="mt-4 body-text text-[#4A5C85] xl:max-w-[600px]">
                      {item.text}
                    </p>
                  </div>
                </div>
