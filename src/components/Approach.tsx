        ...
        <div className="flex flex-col gap-6 xl:grid xl:grid-rows-2 xl:gap-6 xl:h-full">
          ...
          <div className="relative rounded-2xl border border-[#daebff] bg-white p-8 sm:p-10 xl:p-12 min-h-[420px] xl:min-h-0 xl:h-full overflow-hidden">
            ...
            <div className="absolute inset-0">
              ...
              />
              <div className="absolute inset-x-0 top-0 h-[70%] bg-gradient-to-b from-white/85 via-white/40 to-transparent" />
            </div>
            ...
            <div className="absolute inset-x-0 bottom-6 flex flex-col gap-3 overflow-hidden">
              <div className="marquee-track">
                {[...practicesRow1, ...practicesRow1].map((p, i) => (
                  <span
                    key={`r1-${i}`}
                    className="inline-flex min-h-[60px] w-[250px] items-center justify-center whitespace-nowrap rounded-lg bg-white px-6 py-4 text-base leading-[1.5] text-[#1C3C8C] shadow-[0_8px_20px_-8px_rgba(28,60,140,0.25)] shrink-0"
                    style={{ fontFamily: heading }}
                  >
                    {p}
                  </span>
