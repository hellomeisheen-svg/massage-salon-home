...
const environmentItems: { title: string; text: string }[] = [
  {
    title: "Профессионализм и стерильность",
    text: "Все инструменты проходят стерильную обработку по стандартам гигиены, чтобы вы могли полностью довериться процессу. Используем только одноразовое.",
  },
  {
  ...
  },
  {
    ...
    text: "Перед сеансом обсуждаем самочувствие и подбираем технику без спешки. Одноразовые расходные материалы вскрываются при вас.",
  },
  {
