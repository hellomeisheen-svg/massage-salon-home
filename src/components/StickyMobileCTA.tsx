...
export const StickyMobileCTA = memo(function StickyMobileCTA() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-[1000] p-2 pt-2 bg-gradient-to-t from-[#EFF6FF]/95 via-[#EFF6FF]/80 to-transparent backdrop-blur-[2px] lg:hidden animate-in fade-in slide-in-from-bottom-4 duration-300">
