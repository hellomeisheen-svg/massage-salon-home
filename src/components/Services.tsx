    ...
    variants: [
      {
        ...
        description:
          "Глубокое вакуумное воздействие стеклянными банками — как мягкая стихия огня для тела.\n\nПомогает активизировать кровообращение, разогнать застой и\u00A0глубоко прогреть мышечные слои, давая им возможность расслабиться.\n\nПодходит, если важно снять накопленное напряжение, уменьшить чувство скованности и\u00A0вернуть телу ощущение тепла и\u00A0живой энергии.",
        mobileDescription:
          "Вакуумный массаж стеклянными банками — мягкое «огненное» прогревание тканей.\n\nРазгоняет застой, активизирует кровообращение и\u00A0помогает мышцам глубже расслабиться.\n\nПодходит, когда хочется снять скованность и\u00A0вернуть телу чувство тепла и\u00A0живости.",
        duration: "10\u00A0минут",
        price: "2\u00A0000\u00A0₽",
      },
      {
        ...
        description:
          "Массаж мягкими банками — это деликатная «стихия воздуха», которая бережно работает с\u00A0поверхностными слоями тела.\n\nМягкий вакуум помогает улучшить микроциркуляцию, уменьшить отёчность и\u00A0дать тканям больше свободы и\u00A0подвижности.\n\nПодходит, если важно поддержать лёгкость в\u00A0теле, снизить чувство тяжести и\u00A0мягко запустить процессы восстановления.",
        mobileDescription:
          "Массаж мягкими банками — воздушное, деликатное воздействие на\u00A0ткани.\n\nПомогает улучшить микроциркуляцию, уменьшить отёчность и\u00A0вернуть телу чувство лёгкости.\n\nПодходит, когда хочется снизить тяжесть и\u00A0мягко поддержать восстановление.",
...
function ServiceCard({
  ...
  return (
    <article className="rounded-[12px] border border-[#daebff] bg-white p-6 sm:p-8 transition-shadow duration-300 hover:shadow-[0_20px_50px_-24px_rgba(28,60,140,0.18)] flex flex-col h-auto xl:h-[700px]">
