    ...
    variants: [
      {
        ...
        description:
          "Медицинские пиявки на\u00A0выбранные зоны тела снимают напряжение и\u00A0улучшают микроциркуляцию.",
        mobileDescription:
          "Снятие напряжения и\u00A0поддержка лёгкости медицинскими пиявками.",
        duration: "1,5–2 часа",
        price: "4 800 ₽",
      ...
      },
      {
        ...
        description:
          "Мягкий эстетический уход для\u00A0свежего вида и\u00A0лимфооттока без\u00A0инъекций.",
        mobileDescription:
          "Деликатный уход пиявками для\u00A0свежего и\u00A0отдохнувшего вида лица.",
        duration: "1,5–2 часа",
        price: "4 800 ₽",
    ...
    variants: [
      {
        ...
        subtitle: "30 нитей",
        description:
          "Введение 30 нитей в\u00A0акупунктурные точки для\u00A0тонуса и\u00A0саморегуляции на\u00A02–3 месяца.",
        mobileDescription:
          "30 нитей в\u00A0акупунктурные точки для\u00A0длительной поддержки организма.",
        duration: "1,5 часа",
        price: "20 000 ₽",
      },
    ],
    ...
    variants: [
      {
        ...
        description:
          "Точная ручная работа по\u00A0анатомическим линиям для\u00A0снятия глубоких зажимов.",
        mobileDescription:
          "Работа с мышцами и фасциями возвращает движениям свободу и лёгкость.",
        duration: "2 часа",
        price: "5 000 ₽",
      },
    ],
    ...
    variants: [
      {
        ...
        description:
          "Глубокое прогревание тканей стеклянными банками для\u00A0снятия скованности.",
        mobileDescription:
          "Вакуумное воздействие мягко прогревает ткани и\u00A0снимает скованность.",
        duration: "10 минут",
        price: "2 000 ₽",
      },
      {
        ...
        description:
          "Деликатный массаж мягкими инструментами для\u00A0лёгкости и\u00A0подвижности тканей.",
        mobileDescription:
          "Деликатный вакуум помогает вернуть телу больше лёгкости и\u00A0движения.",
    ...
    variants: [
      {
        ...
        description:
          "Мягкая работа с\u00A0оттоком жидкости для\u00A0снятия отёчности и\u00A0тяжести всего тела.",
        mobileDescription:
          "Мягкий массаж всего тела для\u00A0уменьшения отёчности и\u00A0чувства лёгкости.",
        duration: "2 часа",
        price: "5 000 ₽",
      },
      {
        ...
        description:
          "Бережный лимфодренаж лица для\u00A0свежего вида и\u00A0уменьшения отёков.",
        mobileDescription:
          "Техника снимает отёчность, возвращая лицу свежесть и\u00A0ровный тон.",
        duration: "40 минут",
        price: "2 000 ₽",
      },
    ],
    ...
    variants: [
      {
        ...
        description:
          "Последовательная проработка тела в\u00A0спокойном ритме для\u00A0снятия напряжения.",
        mobileDescription:
          "Проработка тела помогает снять напряжение и\u00A0восстановить силы.",
        duration: "1 час",
        price: "3 000 ₽",
      },
      {
        ...
        description:
          "Массаж головы и\u00A0шеи мягко снимает напряжение и\u00A0облегчает тяжесть.",
        mobileDescription:
          "Массаж головы и\u00A0шеи помогает снять напряжение и\u00A0спокойно отдохнуть.",
        duration: "20 минут",
        price: "1 000 ₽",
      },
      {
        ...
        description:
          "Бережная ручная работа для\u00A0расслабления мимических мышц и\u00A0свежего вида.",
        mobileDescription:
          "Мягкая работа с\u00A0лицом расслабляет мышцы и\u00A0поддерживает тон кожи.",
        duration: "40 минут",
        price: "2 000 ₽",
      },
      {
        ...
        description:
          "Разгрузка зон, которые чаще всего накапливают напряжение в\u00A0течение дня.",
        mobileDescription:
          "Работа с\u00A0нагруженными зонами помогает вернуть спине подвижность.",
        duration: "30 минут",
        price: "1 500 ₽",
      },
      {
        ...
        description:
          "Внимательная проработка ног и\u00A0стоп для\u00A0снятия усталости и\u00A0тяжести.",
        mobileDescription:
          "Проработка стоп помогает снять тяжесть и\u00A0вернуть лёгкость движений.",
        duration: "1 час",
        price: "3 000 ₽",
      },
    ],
