    ...
    variants: [
      {
        ...
        description:
          "Глубокое вакуумное воздействие стеклянными банками прогревает выбранные зоны, снимает скованность и\u00A0расслабляет напряжённые мышцы. Возвращает ощущение тепла, свободы движения и\u00A0живой энергии, поддерживает восстановление после нагрузок.",
        mobileDescription:
      ...
      },
      {
        ...
        description:
          "Деликатный массаж мягкими банками создаёт комфортное вакуумное воздействие, уменьшает чувство тяжести и\u00A0возвращает тканям больше подвижности. Поддерживает лёгкость во\u00A0всём теле, снимает напряжение и\u00A0помогает расслабиться после нагрузок и\u00A0рабочего дня.",
        mobileDescription:
    ...
    variants: [
      {
        ...
        description:
          "Мягкий массаж всего тела с\u00A0вниманием к\u00A0естественным путям оттока жидкости уменьшает отёчность и\u00A0снимает ощущение тяжести. Постепенно возвращает телу внутреннюю лёгкость, комфорт и\u00A0спокойствие, помогает расслабиться и\u00A0легче двигаться.",
        mobileDescription:
