    ...
    variants: [
      {
        ...
        subtitle: "30 нитей",
        description:
          "Аккуратная постановка 30 тонких рассасывающихся нитей на всё тело поддерживает мягкие ткани, деликатно освежает кожу и помогает ей выглядеть более собранной и отдохнувшей без резких перемен во внешности.",
        mobileDescription:
          "Мягкое армирование 30 тонкими рассасывающимися нитями на всё тело поддерживает кожу и тонус тканей.",
        duration: "60\u00A0минут",
        price: "20\u00A0000\u00A0₽",
      },
    ],
