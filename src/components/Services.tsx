    ...
    variants: [
      {
        ...
        description:
          "Бережная постановка медицинских пиявок на выбранные зоны тела. Помогает мягко разогнать застой, улучшить локальное кровообращение и разгрузить напряжённые участки. Подходит, если хочется поддержать общее самочувствие, снизить ощущение тяжести в теле и дать организму ресурс на восстановление.",
        duration: "120\u00A0минут",
        price: "4\u00A0800\u00A0₽",
