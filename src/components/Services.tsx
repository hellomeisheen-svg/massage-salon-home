...
function ServiceCard({
  ...
  return (
    <article className="card-lift rounded-[12px] border border-[#daebff] bg-white p-6 sm:p-8 sm:pb-8 xl:pb-8 transition-shadow duration-300 hover:shadow-[0_20px_50px_-24px_rgba(28,60,140,0.18)] flex flex-col h-auto min-h-[640px] sm:min-h-0 xl:min-h-[700px]">
