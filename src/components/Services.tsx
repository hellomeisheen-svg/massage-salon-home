    ...
    variants: [
      {
        ...
        description:
          "Постановка медицинских пиявок на\u00A0выбранные зоны тела создаёт ощущение лёгкости, помогает снять накопленное напряжение и\u00A0поддержать хорошее самочувствие.",
        mobileDescription:
      ...
      },
      {
        ...
        description:
          "Аккуратная постановка пиявок на\u00A0лицо и\u00A0локальные зоны становится частью\u00A0эстетического ухода, поддерживает свежий вид, ровный тон кожи и\u00A0естественное ощущение лёгкости.",
        mobileDescription:
    ...
    variants: [
      {
        ...
        subtitle: "30 нитей",
        description:
          "Аккуратное введение 30 саморассасывающихся нитей в акупунктурные точки всего тела. Работает 2–3 месяца: поддерживает тонус тканей, выравнивает внутренний баланс и помогает организму саморегулироваться без лекарств. Сеанс раз в 3 месяца.",
        mobileDescription:
