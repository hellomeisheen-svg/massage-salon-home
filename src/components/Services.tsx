    ...
    variants: [
      {
        ...
        mobileDescription:
          "Глубокое вакуумное воздействие стеклянными банками мягко прогревает ткани и\u00A0разгоняет застой.\n\nПодходит, если нужно снять скованность и\u00A0вернуть телу ощущение тепла и\u00A0энергии.",
        duration: "10\u00A0минут",
        price: "2\u00A0000\u00A0₽",
      },
      {
        ...
        mobileDescription:
          "Массаж мягкими банками деликатно работает с\u00A0поверхностными слоями и\u00A0улучшает микроциркуляцию.\n\nПомогает уменьшить отёчность и\u00A0вернуть телу чувство лёгкости и\u00A0подвижности.",
