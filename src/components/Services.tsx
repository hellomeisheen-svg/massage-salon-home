    ...
    variants: [
      {
        ...
        description:
          "Аккуратная постановка тонких рассасывающихся нитей поддерживает мягкие ткани лица и\u00A0шеи, деликатно освежает овал, помогает коже выглядеть более собранной и\u00A0отдохнувшей без\u00A0резких перемен во\u00A0внешности.",
        mobileDescription:
          "Мягкое армирование тонкими рассасывающимися нитями поддерживает овал лица и\u00A0свежесть кожи.",
        duration: "60\u00A0минут",
        price: "20\u00A0000\u00A0₽",
      },
    ],
