    ...
    variants: [
      {
        ...
        subtitle: "30 нитей",
        description:
          "Мягкое введение 30 саморассасывающихся нитей в акупунктурные точки всего тела. Работает 2–3 месяца: поддерживает тонус тканей, выравнивает внутренний баланс и помогает организму саморегулироваться без лекарств. Сеанс раз в 3 месяца.",
        mobileDescription:
