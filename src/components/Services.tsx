...
function ServiceCard({
  ...
  return (
    <article className="rounded-[12px] border border-[#daebff] bg-white p-6 sm:p-8 transition-shadow duration-300 hover:shadow-[0_20px_50px_-24px_rgba(28,60,140,0.18)] flex flex-col h-auto min-h-[640px] sm:min-h-[700px] xl:min-h-[700px]">
      ...
      <div className="flex-1 flex flex-col mb-6">
        <div className="flex-1 sm:flex-none xl:flex-1">
          ...
          {/* Description */}
          <p className="mt-6 whitespace-pre-line text-[15px] leading-[24px] text-[#8D9DC5] sm:hidden">
            {variant.mobileDescription || variant.description}
          </p>
          <p className="mt-6 hidden whitespace-pre-line text-[15px] leading-[24px] text-[#8D9DC5] sm:block">
            {variant.description}
          </p>
