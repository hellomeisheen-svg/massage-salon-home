    ...
    variants: [
      {
        ...
        description:
          "Последовательная работа со\u00A0всем телом мягкими ритмичными движениями поддерживает лимфоток и\u00A0помогает разгрузить ткани. Уменьшает отёчность, снимает чувство тяжести и\u00A0даёт больше лёгкости в\u00A0привычном движении в\u00A0течение дня.",
        mobileDescription:
