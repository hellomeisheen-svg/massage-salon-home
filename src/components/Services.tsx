    ...
    variants: [
      {
        ...
        description:
          "Бережная постановка медицинских пиявок на\u00A0выбранные зоны тела. Процедура помогает поддержать ощущение лёгкости, снять часть накопленного напряжения и\u00A0внимательнее отнестись к\u00A0самочувствию. Перед сеансом специалист уточняет противопоказания и\u00A0подбирает схему работы.",
        mobileDescription:
      ...
      },
      {
        ...
        description:
          "Аккуратная постановка пиявок на\u00A0лицо и\u00A0локальные зоны в\u00A0рамках эстетического ухода. Мягкая процедура помогает поддержать более свежий вид, ровный тон и\u00A0ощущение лёгкости. Перед сеансом специалист уточняет противопоказания и\u00A0подбирает схему работы. С\u00A0заботой о\u00A0теле.",
        mobileDescription:
    ...
    variants: [
      {
        ...
        description:
          "Глубокое вакуумное воздействие стеклянными банками на\u00A0выбранные зоны тела. Мягкое прогревание помогает снять скованность, расслабить напряжённые мышцы и\u00A0вернуть ощущение тепла. Интенсивность воздействия подбирается по\u00A0вашему состоянию и\u00A0ощущениям. С\u00A0заботой о\u00A0теле.",
        mobileDescription:
      ...
      },
      {
        ...
        description:
          "Деликатный массаж мягкими банками с\u00A0комфортным вакуумным воздействием. Он\u00A0помогает уменьшить чувство тяжести, поддержать подвижность тканей и\u00A0вернуть телу лёгкость. Интенсивность воздействия подбирается по\u00A0вашему состоянию и\u00A0ощущениям. Для\u00A0бережного ухода и\u00A0отдыха.",
        mobileDescription:
    ...
    variants: [
      {
        ...
        description:
          "Точная ручная работа с\u00A0мышцами и\u00A0фасциями по\u00A0естественным линиям тела. Массаж помогает снять глубокие зажимы, улучшить подвижность и\u00A0вернуть движениям больше свободы. Интенсивность и\u00A0акценты подбираются по\u00A0вашему состоянию. В\u00A0комфортном темпе. Без лишнего давления.",
        mobileDescription:
    ...
    variants: [
      {
        ...
        description:
          "Мягкий массаж всего тела с\u00A0вниманием к\u00A0естественным путям оттока жидкости. Он\u00A0помогает уменьшить отёчность, снять ощущение тяжести и\u00A0вернуть телу внутреннюю лёгкость. Темп и\u00A0интенсивность подбираются по\u00A0вашему состоянию. В\u00A0комфортном темпе. С\u00A0учётом ваших ощущений.",
        mobileDescription:
    ...
    variants: [
      {
        ...
        description:
          "Последовательная работа со\u00A0всем телом мягкими ритмичными движениями. Массаж помогает поддержать лимфоток, уменьшить отёчность и\u00A0постепенно разгрузить ткани. Темп и\u00A0интенсивность подбираются по\u00A0вашему состоянию. Без спешки. В\u00A0комфортном темпе. С\u00A0вниманием к\u00A0запросу.",
        mobileDescription:
      ...
      },
      {
        ...
        description:
          "Деликатная работа с\u00A0оттоком жидкости и\u00A0тонусом кожи лица. Процедура помогает уменьшить отёчность, освежить вид и\u00A0поддержать более чёткий овал. Темп и\u00A0интенсивность подбираются по\u00A0вашему состоянию. В\u00A0комфортном темпе. Бережно и\u00A0последовательно. Без лишнего давления.",
        mobileDescription:
    ...
    variants: [
      {
        ...
        description:
          "Комплексная проработка спины, шеи, рук и\u00A0ног в\u00A0спокойном ритме. Массаж помогает снять мышечное напряжение, глубже расслабиться и\u00A0восстановить силы. Темп и\u00A0интенсивность подбираются по\u00A0вашему состоянию. Без спешки. С\u00A0учётом ваших ощущений. Бережно и\u00A0последовательно.",
        mobileDescription:
      ...
      },
      {
        ...
        description:
          "Массаж головы и\u00A0шейно-воротниковой зоны для\u00A0мягкого переключения и\u00A0отдыха. Он\u00A0помогает расслабить мышцы, облегчить тяжесть в\u00A0голове и\u00A0плечах. Темп и\u00A0интенсивность подбираются по\u00A0вашему состоянию. Без спешки. Бережно и\u00A0последовательно. Для\u00A0спокойного восстановления.",
        mobileDescription:
      ...
      },
      {
        ...
        description:
          "Бережная ручная работа с\u00A0кожей и\u00A0мимическими мышцами лица. Массаж помогает расслабить привычные зажимы, освежить вид и\u00A0поддержать ровный тон кожи. Темп и\u00A0интенсивность подбираются по\u00A0вашему состоянию. Без спешки. Для\u00A0спокойного восстановления. Без лишнего давления.",
        mobileDescription:
      ...
      },
      {
        ...
        description:
          "Работа с\u00A0зонами, которые чаще всего накапливают напряжение в\u00A0течение дня. Массаж помогает снять зажимы, уменьшить тяжесть и\u00A0вернуть спине больше подвижности. Темп и\u00A0интенсивность подбираются по\u00A0вашему состоянию. С\u00A0учётом ваших ощущений. После короткой консультации.",
        mobileDescription:
      ...
      },
      {
        ...
        description:
          "Внимательная проработка ног и\u00A0стоп после активного дня или долгой нагрузки. Массаж помогает снять усталость, уменьшить чувство тяжести и\u00A0вернуть лёгкость движениям. Темп и\u00A0интенсивность подбираются по\u00A0вашему состоянию. В\u00A0комфортном темпе. Бережно и\u00A0последовательно.",
        mobileDescription:
