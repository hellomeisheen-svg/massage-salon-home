...

  {
    ...
    variants: [
      ...
      },
      {
        ...
        description:
          "Деликатный массаж мягкими банками создаёт комфортное вакуумное воздействие, уменьшает чувство тяжести и\u00A0возвращает тканям больше подвижности. Поддерживает лёгкость во\u00A0всём теле, снимает напряжение и\u00A0помогает расслабиться после нагрузок.",
        mobileDescription:
