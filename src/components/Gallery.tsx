...
export default function Gallery() {
  return (
    <section id="galereya" className="scroll-mt-[120px] bg-[var(--color-bg-main)] py-[var(--space-8)] xl:py-[var(--space-10)] pb-0">
      <div className="container-1900 mb-[30px] sm:mb-[60px] xl:mb-[140px] flex flex-col items-center text-center">
        ...
        <p className="mt-6 text-[18px] sm:text-[20px] text-[var(--color-text-main)] font-light max-w-[600px] mx-auto">
