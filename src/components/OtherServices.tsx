    ...
    <section className="bg-[#EFF6FF] ds-section">
      <div className="container-1900">
        ...
        <div
          ...
          className="mt-8 xl:mt-4 flex gap-3 overflow-hidden scroll-smooth p-6 -m-6"
        >
          {items.map((service) => (
            <Link
              key={service.slug}
            ...
            >
              ...
              <div className="mt-auto pt-8 inline-flex items-center gap-1.5 text-[14px] font-medium text-[#1C3C8C] transition-opacity group-hover:opacity-70">
                Подробнее
