...
export const otherServices = [
  ...
  },
  {
    slug: "banki",
    title: "Банки",
    description: "Вакуумный массаж стеклянными и мягкими банками, снимающий тяжесть и возвращающий телу лёгкость и баланс.",
  },
  {
  ...
  },
  {
    ...
    description: "Последовательная работа от стоп до плеч. Улучшает самочувствие и возвращает лёгкость и мягкость по телу.",
  },
  {
  ...
  const Controls = ({ className }: { className: string }) => (
    <div className={className}>
      <button
        ...
        className="h-12 w-12 rounded-lg border border-[#daebff] bg-white flex items-center justify-center text-[#1C3C8C] transition-[background-color,opacity] hover:bg-[#EFF6FF] active:opacity-60 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-white"
      >
