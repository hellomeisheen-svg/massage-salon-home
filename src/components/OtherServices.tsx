...
export const otherServices = [
  {
    slug: "girudoterapiya",
    title: "Гирудотерапия",
    description: "Мягкая работа с пиявками для глубокого расслабления и восстановления внутреннего баланса.",
  },
  {
    slug: "banki",
    title: "Банки",
    description: "Вакуумный массаж стеклянными и мягкими банками. Снимает тяжесть, возвращает лёгкость и свободу движений.",
  },
  {
    slug: "vektornyi-massazh",
    title: "Векторный массаж",
    description: "Точная проработка мышц и фасций. Помогает разгрузить тело и почувствовать свободу движения в повседневной жизни.",
  },
  {
    slug: "limfaticheskii-massazh",
    title: "Лимфатический массаж",
    description: "Мягкое воздействие для уменьшения отёчности и лёгкости. Подходит при усталости, тяжести в ногах и после нагрузки.",
  },
  {
    slug: "limfodrenazhnyi-massazh",
    title: "Лимфодренажный массаж",
    description: "Последовательная работа от стоп до плеч. Улучшает самочувствие и возвращает комфорт в теле после нагрузки.",
  },
  {
    slug: "klassicheskii-massazh",
    title: "Классический массаж",
    description: "Комплексная проработка тела. Снимает напряжение после рабочей недели, помогает расслабиться и восстановить силы.",
  },
  {
    slug: "ketgut",
    title: "Акупунктурный кетгут",
    description: "Постановка тонких нитей в акупунктурные точки. Мягкая и длительная поддержка организма, помогающая телу расслабиться.",
  },
