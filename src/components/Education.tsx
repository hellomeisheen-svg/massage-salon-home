...
export function Education() {
  return (
    <section id="obrazovanie" className="bg-[#EFF6FF] py-[60px] xl:pt-[120px] xl:pb-0">
      <div className="container-1900 mb-[60px] sm:mb-[70px] xl:mb-[120px] flex flex-col items-center text-center">
        <svg
          aria-hidden="true"
          viewBox="0 0 24 24"
          fill="currentColor"
