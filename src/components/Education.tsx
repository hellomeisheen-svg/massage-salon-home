      ...
      <div className="container-1900 grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-5 items-stretch">
        ...
        <div className="relative rounded-[12px] min-h-[480px] sm:min-h-[800px] xl:min-h-0 xl:h-full flex flex-col sm:block">
          ...
          <div className="relative sm:absolute inset-x-0 bottom-0 mt-4 sm:mt-0 xl:px-8 xl:pb-8">
            <div className="rounded-[12px] border border-[#DAEBFF] bg-white p-8 sm:p-12 xl:p-10 shadow-[0_20px_50px_-12px_rgba(74,127,214,0.08)] flex flex-col sm:flex-row sm:items-end justify-between gap-6 sm:gap-10">
              ...
              <img
                ...
                width={240}
                height={97}
                className="h-auto w-[180px] sm:w-[200px] xl:w-[240px] shrink-0 self-end sm:self-auto"
                loading="lazy"
              />
            </div>
          </div>
