...
export function Programs({ prioritizeKeys }: ProgramsProps = {}) {
  ...
  return (
    <section id="programs" className="scroll-mt-[140px] bg-[#EFF6FF] ds-section !pb-0 md:!pb-[70px] xl:!pb-0">
      <div className="container-1900 grid grid-cols-1 xl:grid-cols-2 gap-8 sm:gap-5 items-start">
        ...
        <article className="ds-card ds-bento-shadow p-5 sm:p-8 flex flex-col h-[620px] sm:h-[671px] xl:h-auto xl:min-h-[700px]">
