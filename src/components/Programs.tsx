  ...
  return (
    <section id="programs" className="scroll-mt-[120px] bg-[#EFF6FF] ds-section">
      <div className="container-1900 grid grid-cols-1 xl:grid-cols-2 gap-8 sm:gap-5 items-start">
        ...
        <article className="ds-card ds-bento-shadow p-5 sm:p-8 flex flex-col h-[560px] sm:h-[671px] xl:h-auto xl:min-h-[700px] border border-[#DAEBFF] max-w-full overflow-hidden">
          <h3 className="font-noto-serif-narrow ds-h3 text-[#1C3C8C] max-[380px]:text-[24px] max-sm:text-[27px] max-sm:whitespace-nowrap">
            {program.name}
          </h3>
