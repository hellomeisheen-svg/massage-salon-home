  ...
  return (
    <section id="programs" className="scroll-mt-[140px] bg-[#EFF6FF] py-[60px] sm:py-[70px] xl:pt-[140px] xl:pb-0">
      <div className="container-1900 grid grid-cols-1 xl:grid-cols-2 gap-8 sm:gap-5 items-start">
        ...
        <article className="rounded-[12px] border border-[#daebff] bg-white p-6 sm:p-8 transition-shadow duration-300 hover:shadow-[0_20px_50px_-24px_rgba(28,60,140,0.18)] flex flex-col h-[720px] xl:h-auto xl:min-h-[700px]">
          <h3
          ...
          <div className="flex-1 min-h-0 xl:min-h-fit xl:overflow-visible overflow-hidden">
            ...
            <div className="sm:hidden mt-6 border-t border-[#daebff] divide-y divide-[#daebff] h-full overflow-y-auto">
              {computedItems.map((it, idx) => (
